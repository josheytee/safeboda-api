...
class PromoCodeValidityTest extends TestCase
{
    ...
    public function testPromoCodeIsValid()
    {
        ...
        $response->seeJsonStructure([
            'promoCode' => ['id', 'code', 'radius', 'amount', 'created_at', 'expires_at'],
            'polyline'
        ]);
    ...
    public function testPromoCodeIsInvalid()
    {
        $promoCode = factory(App\PromoCode::class)->create();
        $response = $this->post(
            route('promo-code-validity', ['code' => $promoCode->code]),
            [
    ...
    {
        $promoCode = factory(App\PromoCode::class)->create();
        $response = $this->post(route('promo-code-validity', ['code' => $promoCode->code]), []);
    ...
    {
        $response = $this->post(
            route('promo-code-validity', ['code' => "AAAAAA"]),
            [
                'origin' => ['lat' => 7.7634697, 'lon' => 4.5341617],
